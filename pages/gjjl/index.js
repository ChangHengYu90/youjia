...
Page({
  ...
  getgjjl(){
    ...
    util.requestLoading(that.data.apis + '/api/user/phonebookfollowlist.aspx', foptions, data, '', function (res) {
      console.log(res)
      if (res.code == '200') {
        let shuju = res.data
  ...
  addgjjl(){
    ...
    util.requestLoading(that.data.apis + '/api/user/addphonebookfollow.aspx', foptions, data, '', function (res) {
      console.log(res)
      if (res.code == '200') {
        wx.showToast({
          title: res.message,
  ...
  deljl(e){
   ...
   let institutionId = wx.getStorageSync('user').id
    ...
    util.requestLoading(that.data.apis + '/api/user/deletephonebookfollow.aspx', foptions, data, '', function (res) {
      console.log(res)
      if (res.code == '200') {
        wx.showToast({
          title: res.message,
