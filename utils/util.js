...
function request(url, foptions, params, success, fail) {
  this.requestLoading(url, foptions, params, "", success, fail)
}
// 展示进度条的网络请求
// url:网络请求的url
// params:请求参数
...
// success:成功的回调函数
// fail：失败的回调
function requestLoading(url, foptions, params, message, success, fail) {
  console.log(params)
